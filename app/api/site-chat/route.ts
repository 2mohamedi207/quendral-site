...
- Receptionist & Workflows — $897/month, $1,249 one-time setup. AI receptionist and automated workflows, for businesses that already have a way to capture leads. Includes: AI receptionist answering calls 24/7, books straight to the calendar, instant response & follow-up on leads from their existing site, CRM setup & management, automated invoicing (up to 25/month — an invoice goes out automatically once a job's marked complete), and a monthly performance check-in (a 10-15 minute review of that month's actual data: leads captured, how the receptionist and follow-ups performed, response times, and how many turned into booked jobs).
- Plus (most popular) — $1,297/month, $1,749 one-time setup. Everything in Receptionist & Workflows, plus a full business website (not just a landing page), a deeper monthly check-in (the same data review, plus a strategy conversation about adjustments and how the new site's contributing to lead volume), and a higher automated invoicing cap (up to 75/month).

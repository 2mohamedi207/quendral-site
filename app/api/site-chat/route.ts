...
- Core — $497/month, $749 one-time setup. Lead capture, instant response, follow-up, and CRM. Includes: dedicated lead-capture landing page, instant SMS & email response, follow-up sequence on every estimate, CRM setup & management.
- Receptionist & Workflows — $697/month, $999 one-time setup. AI receptionist and automated workflows, for businesses that already have a way to capture leads. Includes: AI receptionist answering calls 24/7, books straight to the calendar, instant response & follow-up on leads from their existing site, CRM setup & management.
- Plus (most popular) — $897/month, $1,249 one-time setup. Everything in Receptionist & Workflows, plus a full business website (not just a landing page) and monthly strategy check-ins.
- Multi-Crew — $1,497/month, $1,999 one-time setup. Everything in Plus, plus multi-crew routing by service area, custom reporting, and a dedicated success manager.

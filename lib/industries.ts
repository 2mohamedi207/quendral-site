    ...
    pricingTiers: [
      ...
      },
      {
        ...
        features: [
          ...
          "CRM setup & management",
          "Automated invoicing (up to 25/month)",
        ...
        detailedSteps: [
          ...
          "We set up and clean your CRM — every lead deduped, tagged, and moved through clear pipeline stages.",
          "Once a job's marked complete, an invoice goes out automatically — no more chasing paperwork after the work's done. Included for up to 25 invoices a month.",
          "Every month, you get a 10-15 minute check-in built around your actual data — leads captured, how the receptionist and follow-ups performed, response times, and how many turned into booked jobs, so you know exactly what the system did for you that month.",
        ],
        highlighted: false,
      },
      {
        ...
        setupPrice: "$1,749",
        monthlyPrice: "$1,297",
        description: "Everything in Receptionist & Workflows, plus a full business website.",
        features: [
          "Everything in Receptionist & Workflows",
          "Full business website — not just a landing page",
          "Monthly check-ins go deeper — data plus strategy",
          "Automated invoicing (up to 75/month)",
        ],
        detailedSteps: [
          ...
          "Your monthly check-in goes further than the data summary — we sit down and adjust the system together based on what's working, including how the new site's contributing to lead volume.",
          "Your automated invoicing cap increases to 75 a month, to match the extra job volume a full website tends to bring in.",
        ],
        highlighted: true,
      },
      {
        ...
        detailedSteps: [
          ...
          "Automated invoicing is uncapped at this tier — no monthly limit, matching multi-crew job volume.",
        ],
        highlighted: false,
      },
    ],
